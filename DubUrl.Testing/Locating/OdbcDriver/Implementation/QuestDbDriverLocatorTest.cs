...
{
    public class QuestDbDriverLocatorTest
    {
        ...
        public void Locate_SingleElementMatching_ElementReturned()
        {
            ...
            var driverLocator = new QuestDbDriverLocator(driverLister);
        ...
        public void Locate_SingleElementMatchingWhenEncodingApplied_ElementReturned()
        {
            ...
            var driverLocator = new QuestDbDriverLocator(driverLister, EncodingOption.Unicode, ArchitectureOption.x86);
            var driver = driverLocator.Locate();
        ...
        public void Locate_MultipleElementMatching_BestElementReturned()
        {
            ...
            var driverLocator = new QuestDbDriverLocator(driverLister, EncodingOption.Unicode, ArchitectureOption.x64);
            var driver = driverLocator.Locate();
        ...
        public void Locate_ElementNonMatching_ElementNotReturned()
        {
            ...
            var driverLocator = new QuestDbDriverLocator(driverLister, EncodingOption.ANSI, ArchitectureOption.x86);
            var driver = driverLocator.Locate();
            Assert.That(driver, Is.EqualTo("PostgreSQL ANSI"));
        }
