...
public class MssqlNCliProviderLocatorTest
{
    ...
    {
        var providerLister = new FakeProviderLister([new ProviderInfo("SQLNCLI11", "SQL Server Native Client 11.0")]);
    ...
    public void Locate_MultipleElementMatching_BestElementReturned()
    {
        var providerLister = new FakeProviderLister(
            [ new ProviderInfo("SQLNCLI10", "SQL Server Native Client 10.0"),
