...
public class AceProviderLocatorTest
{
    ...
    {
        var providerLister = new FakeProviderLister([new ProviderInfo("Microsoft.ACE.OLEDB.16.0", "Microsoft Office 16.0 Access Database Engine OLE DB Provider")]);
    ...
    public void Locate_MultipleElementMatching_BestElementReturned()
    {
        var providerLister = new FakeProviderLister(
            [ new ProviderInfo("Microsoft.ACE.OLEDB.12.0", "Microsoft Office 12.0 Access Database Engine OLE DB Provider"),
