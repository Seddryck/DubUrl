...
public class OracleManagedDataAccessRewriterTest
{
    ...
    public void Map_UrlInfo_DataSource(string expected, string host = "host", string segmentsList = "", int port = 0)
    {
        ...
        Assert.Multiple(() =>
        {
            ...
            Assert.That(result, Does.ContainKey(OracleManagedDataAccessRewriter.DATASOURCE_KEYWORD));
            Assert.That(result[OracleManagedDataAccessRewriter.DATASOURCE_KEYWORD], Is.EqualTo(expected));
        });
    }
    ...
    public void Map_UrlInfoWithUsernamePassword_Authentication()
    {
        ...
        Assert.Multiple(() =>
        {
            ...
            Assert.That(result[OracleManagedDataAccessRewriter.USERNAME_KEYWORD], Is.EqualTo("user"));
        });
