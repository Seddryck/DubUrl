...
{
    protected SchemeMapper SchemeMapper { get; set; }
    ...
    public void SetupFixture()
    {
        ...
        SchemeMapper = schemeMapperBuilder.Build();
    }
    ...
    {
        var connectionUrl = new ConnectionUrl(ConnectionString, SchemeMapper);
    ...
    {
        var connectionUrl = new ConnectionUrl(ConnectionString.Substring(0, ConnectionString.Length-2), SchemeMapper);
    ...
    {
        var db = new DatabaseUrl(new ConnectionUrlFactory(SchemeMapper), ConnectionString);
